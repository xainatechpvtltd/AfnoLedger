...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
      "AfnoLedger je potpuno poslovno rješenje s inventarom, računima, prodajom, troškovima i dobitkom/gubitkom.",
    ),
    ...
    "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
      "Značajke su važan dio koji čini AfnoLedger drugačijim od tradicionalnih rješenja.",
    ),
    ...
    "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
      "AfnoLedger aplikacija je besplatna i jednostavna za korištenje. Zapravo, jedan je od najboljih POS sustava diljem svijeta.",
    ),
