...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
      "AfnoLedger on täydellinen liiketoimintaratkaisu varaston, tilien, myynnin, kulujen ja voiton/tappion osalta.",
    ),
    ...
    "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
      "Ominaisuudet ovat tärkeä osa, joka erottaa AfnoLedgern perinteisistä ratkaisuista.",
    ),
    ...
    "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
      "AfnoLedger -sovellus on ilmainen ja helppokäyttöinen. Itse asiassa se on yksi parhaista POS-järjestelmistä maailmassa.",
    ),
