...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "allBusinessolutionDescrip": MessageLookupByLibrary.simpleMessage(
      "AfnoLedger - это полное бизнес-решение с учетом склада, счетов, продаж, расходов и прибыли/убытков.",
    ),
    ...
    "choseyourfeatureDesciption": MessageLookupByLibrary.simpleMessage(
      "Функции - это важная часть, которая делает AfnoLedger отличной от традиционных решений.",
    ),
    ...
    "easytheusedesciption": MessageLookupByLibrary.simpleMessage(
      "Приложение AfnoLedger бесплатное и легкое в использовании. Фактически, это одна из лучших POS-систем в мире.",
    ),
